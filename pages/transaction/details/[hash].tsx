    ...
    <>
      <Row>
        <Col className="d-flex justify-content-end transaction-tabs">
          <Button variant="primary" className="transaction-tabs_buttons transaction-tabs_buttons-overview" onClick={() => setView("Overview")}>
            Overview
          </Button>
          <Button variant="primary" className="transaction-tabs_buttons transaction-tabs_buttons-logs" onClick={() => setView("Logs")}>
            Logs
          </Button>
        </Col>
      </Row>
      ...
      }
      {
        ...
        <>
          <Row>
            <Col className='mb-4'>
              <h4><b>Transaction Receipt Event Logs</b></h4>
            </Col>
          </Row>
          <Row>
            <Col>
                    ...
                    <td>
                      <div className="transactions-logs">
                        <div className="transactions-logs-row">
                          <div className="transactions-logs-number">
                            1
                          </div>
